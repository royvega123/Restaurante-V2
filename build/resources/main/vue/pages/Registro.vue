        ...
        <div class="signin-overlay pa-5">
            <v-card class="signin-card pa-5">
                <h1 class="mt-0 mb-5">Registrar</h1>
                                   ...
                                   <v-text-field v-model="editedItem.lastname" :rules="nameRules" label="Apellido Paterno" required></v-text-field>

                                   <v-text-field v-model="editedItem.maidname" label="Apellidos Materno" required></v-text-field>

                                   <v-text-field v-model="editedItem.firstname" label="Nombre" required></v-text-field>

                                   <v-text-field v-model="editedItem.userId" label="Usuario" required></v-text-field>

                                   <v-text-field type="password" v-model="editedItem.password" label="Contraseña" required></v-text-field>
